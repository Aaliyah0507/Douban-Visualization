...
const SCENES = [
  {
    ...
    desc: "Each glowing particle is one movie. Hover to inspect details."
  },
  {
    id: "year",
    title: "Year Lens",
  ...
  },
  {
    id: "genre",
    title: "Genre Morph",
    desc: "Particles move and settle into a thematic particle bar chart by genre."
  },
  {
    id: "rating",
    title: "Rating Ranking Tags",
    desc: "Top-rated and high-vote movies are shown in ranked tags."
  },
  {
    id: "map",
  ...
  },
  {
    ...
    desc: "Switch between high/low datasets and sort directors by film count or average score."
  }
];
...
function renderDirectorScene() {
  ...
  directorControls.style.left = '12px';
  directorControls.style.top = '12px';
  directorControls.style.bottom = 'auto';
  directorControls.style.width = 'auto';
  directorControls.style.flexDirection = 'row';
  directorControls.style.alignItems = 'center';
  directorControls.style.gap = '8px';
  directorControls.style.overflow = 'visible';
  directorChartPanel.classList.remove('hidden');
  directorChartPanel.style.inset = '64px 12px 12px 12px';
  ratingRankPanel.classList.add('hidden');
  yearTagsContainer.classList.add('hidden');
  hoverTip.classList.add('hidden');
